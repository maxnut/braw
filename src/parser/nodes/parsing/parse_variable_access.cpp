...
Result<std::shared_ptr<AST::VariableAccessNode>> Parser::parseVariableAccess(TokenCursor& cursor, const std::filesystem::path& path, std::shared_ptr<AST::FileNode> file) {
