...
struct InstructionOpcode {
    ...
    bool operator<(const InstructionOpcode& other) const {
        return std::tie(opcode1, opcode2) < std::tie(other.opcode1, other.opcode2);
    }
...
constexpr InstructionOpcode Addss    = {0x00, 0x0F, 0x58};    // ADDSS (SSE)
constexpr InstructionOpcode Addsd    = {0x00, 0x0F, 0x58};    // ADDSD (SSE2)
constexpr InstructionOpcode Sub      = {0x00, 0x29};          // SUB
constexpr InstructionOpcode Subss    = {0x00, 0x0F, 0x5C};    // SUBSS (SSE)
constexpr InstructionOpcode Subsd    = {0x00, 0x0F, 0x5C};    // SUBSD (SSE2)
constexpr InstructionOpcode Imul     = {0x00, 0x69};          // IMUL (with immediate operand)
constexpr InstructionOpcode Mulss    = {0x00, 0x0F, 0x59};    // MULSS (SSE)
constexpr InstructionOpcode Mulsd    = {0x00, 0x0F, 0x59};    // MULSD (SSE2)
...
constexpr InstructionOpcode Movss    = {0x00, 0x0F, 0x10};    // MOVSS (SSE)
constexpr InstructionOpcode Movsd    = {0x00, 0x0F, 0x10};    // MOVSD (SSE2)
...
constexpr InstructionOpcode Ucomiss  = {0x00, 0x0F, 0x2E};    // UCOMISS (SSE comparison)
constexpr InstructionOpcode Ucomisd  = {0x00, 0x0F, 0x2E};    // UCOMISD (SSE2 comparison)
